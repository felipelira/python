...
# IMPORTANT
# Because it use a tabular BLAST result, it needs to contain two specific values ("[these values]")
# Include these parameter when selecting the --outfmt 6 at Diamond command line:
# qseqid sseqid pident length mismatch gapopen qstart qend [qlen] sstart send [slen] evalue bitscore
